    ...
    useEffect(() => {
        ...
        if (metaDescription) {
            metaDescription.setAttribute(
                'content',
                'Projetos de pesquisa do Departamento Acadêmico de Exatas da UTFPR Guarapuava. Linhas de pesquisa em Matemática Aplicada, Física Experimental e Química Analítica.'
            );
        }
        ...
        if (metaKeywords) {
            metaKeywords.setAttribute(
                'content',
                'pesquisas, projetos, DAEx, UTFPR, Guarapuava, Matemática Aplicada, Física Experimental, Química Analítica, iniciação científica'
            );
        }
        ...
        if (canonical) {
            canonical.setAttribute(
                'href',
                `${import.meta.env.VITE_SITE_URL || 'https://daext.gp.utfpr.edu.br'}/pesquisas`
            );
        }
        ...
        const structuredData = {
            ...
            description:
                'Projetos de pesquisa do Departamento Acadêmico de Exatas da UTFPR Guarapuava',
