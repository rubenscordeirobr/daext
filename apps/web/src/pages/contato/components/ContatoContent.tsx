            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-[#8d9199] max-w-3xl mx-auto leading-relaxed">
                        Estamos aqui para esclarecer suas dúvidas, fornecer informações sobre nossos
                        cursos e pesquisas, ou estabelecer parcerias acadêmicas. Entre em contato
                        conosco!
                    </p>
                </div>
                                ...
                                {contactInfo.map((info, index) => (
                                    <div key={index} className="flex items-start space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#8d9199] text-sm">
                                                {info.description}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="informacoes-gerais">
                                            Informações Gerais
                                        </option>
