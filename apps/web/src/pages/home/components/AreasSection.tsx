    ...
    const areas = [
        {
            title: 'Matemática',
            description:
                'Pesquisas em álgebra, análise, geometria, matemática aplicada e educação matemática.',
        ...
        },
        {
            title: 'Física',
            description:
                'Estudos em física teórica, experimental, materiais, energia e fenômenos naturais.',
            icon: 'ri-atom-line',
        ...
        },
        {
            title: 'Química',
            description:
                'Pesquisas em química orgânica, inorgânica, analítica, físico-química e materiais.',
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-[#8d9199] max-w-3xl mx-auto">
                        O DAEx desenvolve atividades de ensino, pesquisa e extensão em três grandes
                        ...
                        <div key={index} className="group cursor-pointer">
                            <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100">
                                <div className="relative h-48 overflow-hidden">
                                    ...
                                    />
                                    <div
                                        className={`absolute inset-0 bg-gradient-to-t ${area.color} opacity-20 group-hover:opacity-30 transition-opacity duration-300`}
                                    ></div>
                                </div>
                                ...
                                <div className="p-6">
                                    <div className="flex items-center mb-4">
                                        <div
                                            className={`w-12 h-12 rounded-lg bg-gradient-to-r ${area.color} flex items-center justify-center mr-4`}
                                        >
