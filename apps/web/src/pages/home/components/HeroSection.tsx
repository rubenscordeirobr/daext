            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-lg text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
                        Promovendo excelência em ensino, pesquisa e extensão nas áreas de
                        Matemática, Física e Química. Conectando conhecimento científico com
                        inovação tecnológica para transformar o futuro.
                    </p>
