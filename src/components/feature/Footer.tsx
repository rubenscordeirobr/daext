          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-300">Departamento de Exatas - UTFPR Guarapuava</p>
              </div>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed">
              Departamento Acadêmico de Exatas da Universidade Tecnológica Federal do Paraná - Campus Guarapuava
            </p>
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-3">
                ...
                <span className="text-gray-300 text-sm">
                  Av. Professora Laura Pacheco Bastos, 800<br />
