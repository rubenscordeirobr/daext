...
const ContatoPage = () => {
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Entre em contato com o Departamento Acadêmico de Exatas da UTFPR Guarapuava. Endereço, telefone, e-mail e formulário de contato para dúvidas e informações.');
    }

    const metaKeywords = document.querySelector('meta[name="keywords"]');
    if (metaKeywords) {
      metaKeywords.setAttribute('content', 'contato, endereço, telefone, email, DAEx, UTFPR, Guarapuava, localização, formulário');
    }

    const canonical = document.querySelector('link[rel="canonical"]');
    if (canonical) {
      canonical.setAttribute('href', `${import.meta.env.VITE_SITE_URL || 'https://daext.gp.utfpr.edu.br/'}/contato`);
    }
    ...
    const structuredData = {
      ...
      "description": "Entre em contato com o Departamento Acadêmico de Exatas da UTFPR Guarapuava",
